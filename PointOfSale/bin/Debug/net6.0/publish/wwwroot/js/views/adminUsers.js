    ...
    tableData = $("#tbData").DataTable({
        ...
        "columns": [
            ...
            },
            {
                ...
                //"defaultContent": '<button class="btn btn-primary btn-edit btn-sm mr-2"><i class="nav-icon fas fa-edit text-info"></i></button>' +
                //    '<button class="btn btn-danger btn-delete btn-sm"><i class="nav-icon fas fa-trash text-info"></i></button>',
                "orderable": false,
                "searchable": false,
                "width": "80px"
            }
